"""peasy-pdf API client — Access Peasy PDF tools via REST API.
...
Usage::
    ...
    tool = api.get_tool("pdf-merge")  # single tool detail
"""
...
class PeasyPdfAPI:
    ...
    def __init__(self, base_url: str = "https://peasypdf.com") -> None:
